...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
        ...
        $query = "insert into users(user_id,user_name,password,card_no,expiry_date,cvv) values('$user_id','$user_name','$password','$card_no','$expiry_date','$cvv')";
    ...
    <div class="step1">
        <div class="navbar">
            ...
            <div class="navbar_right">
                <a href="login.php" style="text-decoration:none;color:#000;"><button class="btn">Log In</button></a>
            </div>
            <hr>
        </div>
            ...
            <div class="content_details">
                <form action="" method="post">
                    <table>
                        ...
                        <tr>
                            <h2>Set up your debit or credit <br> card</h2>
                        </tr>
                        <tr>
                            <h2> <i class="fa fa-cc-visa" style="color:navy;"></i>&nbsp;
                        ...
                        <tr>
                            <div>
                                <input type="text" placeholder="Card number" name="card_no" id="form_sname" class="text">
                                <span class="error_form" id="sname_error_message"></span>
                            </div>
                        </tr><br>
                        <tr>
                            <div>
                                <input type="text" placeholder="Expiration date(MM/YY)" name="expiry_date" id="form_snam" class="text">
                                <span class="error_form" id="sname_error_messag"></span>
                            </div>
                        </tr><br>
                        <tr>
                            <div>
                                <input type="text" placeholder="Security code(CVV)" id="form_retype_password" name="cvv" class="text">
                                <span class="error_form" id="retype_password_error_message"></span>
                            </div>
                        </tr><br>
                        <tr>
                            <div><br><input type="text" class="text" placeholder="charge"></div>
                        </tr><br>
        ...
        $(function() {
            ...
            function check_sname() {
                ...
                if (pattern.test(sname) && sname !== '') {
                    ...
                    $("#sname_error_message").html("Invalid card Number");
