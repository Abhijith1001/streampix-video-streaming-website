...
<br><br>
        <form class="d-none d-md-flex ms-4" method="post">
            <input class="form-control bg-dark border-0" type="search" style="color: #fff;" name="search" placeholder="Search">
            <input type="submit" class="btn btn-secondary m-2" name="submit">
        </form>
</body>
          ...
          <table>
           <tr>
            ...
            <tr>
                ...
                <td rowspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"><img src='<?php echo $row->img  ?>' alt="hai"></a> </td>
        </table>
<?php
    } else {
