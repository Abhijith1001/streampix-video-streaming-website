...
<body>
    <div class="full">
        ...
        <div id="carouselExampleCaptions" class="carousel slide  top" data-interval="1000" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/img1.jpg" class="d-block w-100 top" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/img2.jpg" class="d-block w-100 top" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item">
        ...
        <div class="item">
                <a href="page.php"><img src="img/c11.jpg"  class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c12.jpg"  class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c13.jpg"  class="imgtras" alt=""></a>
            </div>
            <div class="item">
            ...
            <div class="item">
                <a href="page.php"> <img src="img/c16.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c17.jpg" class="imgtras" alt=""></a>
            </div>
        </div>
        <br>
        ...
        <div class="owl-carousel owl-theme">
        <div class="item">
                <a href="page.php"><img src="img/c21.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c22.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c23.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c24.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/a14.jpg" class="imgtras" alt=""></a>
            </div>
        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                <a href="page.php"> <img src="img/c14.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c15.jpg" class="imgtras" alt=""></a>
            </div>
            <div class="item">
                <a href="page.php"> <img src="img/c16.jpg" class="imgtras" alt=""></a>
            </div>
